...
class PhrasesControllerTest < ActionController::TestCase
  ...
  test "should create phrase" do
    assert_difference('Phrase.count') do
      post :create, phrase: { caracteristique_id: @phrase.caracteristique_id, condition: @phrase.condition, libelle: @phrase.libelle }
    end
  ...
  test "should update phrase" do
    patch :update, id: @phrase, phrase: { caracteristique_id: @phrase.caracteristique_id, condition: @phrase.condition, libelle: @phrase.libelle }
    assert_redirected_to phrase_path(assigns(:phrase))
  end
